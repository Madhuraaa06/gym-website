                ...
                <div>
                    ...
                    <div className="about">
                        ...
                        <div className="about-pics">
                            <div className="about-one weightlifting" style={{ backgroundImage: 'url(images/39.png)' }}>
                                <img src="" />
                                <h3>weightlifting</h3>
                            ...
                            <div className="about-one bodybuilding" style={{ backgroundImage: 'url(images/40.png)' }}>
                                <img src="" />
                                <h3>Bodybuilding</h3>
                            ...
                            <div className="about-one Crossfit" style={{ backgroundImage: 'url(images/42.png)' }}>
                                <img src="" />
                                <h3>Crossfit</h3>
                            ...
                            <div className="about-one boxing" style={{ backgroundImage: 'url(images/41.png)' }}>
                                <img src="" />
                                <h3>Boxing</h3>
                ...
                <div className="contactus">
                    ...
                    <div className="contactus-elements">
                        ...
                        <div className="right-side">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13326.555743183117!2d72.90007818311688!3d19.084287311514455!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c62da38e777f%3A0x34c3a14c86f76434!2sGhatkopar%20Station%20(E)!5e0!3m2!1sen!2sin!4v1694965124021!5m2!1sen!2sin" width="60%" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
